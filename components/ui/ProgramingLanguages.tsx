...
export default function ProgramingLanguages() {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center overflow-hidden">
      <div className="relative w-full h-full max-w-[450px] max-h-[450px] flex items-center justify-center" onMouseEnter={() => setIsPaused(true)} onMouseLeave={() => setIsPaused(false)}>
        <div className="w-20 h-20 bg-blue-600 rounded-full flex items-center justify-center z-10 relative shadow-2xl">
